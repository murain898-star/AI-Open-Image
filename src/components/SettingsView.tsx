            ...
            {activeTab === 'tc' && (
              <div>
                ...
                <div className="prose prose-indigo dark:prose-invert text-gray-600 dark:text-gray-300 space-y-4">
                  ...
                  <p>Credits are deducted upon successful generation. Video generation costs depend on resolution (1 credit for 720p, 2 credits for 1080p, and 3 credits for 4K) multiplied by the video length. The base cost is for every 5 seconds. So a 10-second video costs 2x the base cost. Image generation ranges from 0 credits (Low Res) to 4 credits (Maximum quality). Subscriptions are billed monthly. Unused credits may roll over depending on your specific plan terms.</p>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mt-1">Image generation costs 0 to 4 credits based on quality. Generating a video costs between 1 to 3 credits based on resolution, and this cost multiplies for every 5 seconds of video length (e.g., a 10s video is 2x the base charge).</p>
                  </div>
                  <div>
