          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="text-[11px] text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-800/40 border border-gray-100 dark:border-gray-700/50 p-2.5 rounded-xl text-center">
                  Demo User: <span className="font-semibold text-gray-600 dark:text-gray-300 select-all">demo@ai-openimage.com</span><br />
                  Password: <span className="font-semibold text-gray-600 dark:text-gray-300 select-all">razorpaydemo123</span>
                </div>
